 ...
 *
 * Sample usage :
 * parent.viewBinding(ItemLayoutBinding::inflate)
 */
inline fun <T : ViewBinding> ViewGroup.viewBinding(viewBindingFactory: (LayoutInflater, ViewGroup, Boolean) -> T): T =
 ...
 *
 * Sample usage :
 * val binding by viewBindingDialog(DialogBinding::inflate)
 */
inline fun <T : ViewBinding> Context.viewBindingDialog(
